...
@section('content')
    {!! Form::open(['route' => ['admin.$LOWERCASE_MODULE_NAME$.$LOWERCASE_CLASS_NAME$.update', $$MODEL$->id], 'method' => 'put']) !!}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @include('$LOWERCASE_MODULE_NAME$::admin.$SNAKE_CASE_ENTITY$.fields-translatable')

            @include('$LOWERCASE_MODULE_NAME$::admin.$SNAKE_CASE_ENTITY$.fields')
